<template>
  <div 
    :class="[
      ...
      'cursor-pointer h-[300px] w-[220px]',
  ...
  >
    ...
    <div class="absolute inset-0 pointer-events-none overflow-hidden">
      <div 
        class="absolute inset-0 bg-center bg-no-repeat bg-contain opacity-5 
               transform group-hover:scale-110 transition-transform duration-1000 ease-in-out"
      ></div>
    ...
    <div 
      class="absolute inset-0 border border-[#3c3c36] m-1.5 opacity-0 group-hover:opacity-100 
             transition-all duration-500 animate-glitch"
    ></div>
    ...
    <div class="p-5 flex flex-col items-center h-full relative z-10">
      ...
      >
        ...
        <div 
          v-if="selected && !estaInscrito" 
          class="absolute inset-0 bg-[#72211d]/30 flex items-center justify-center backdrop-blur-sm"
        >
        ...
        >
          <div class="transform rotate-[-30deg] bg-[#72211d] text-[#e2d9ca] px-6 py-2 font-bold text-2xl tracking-wider shadow-lg border border-[#e2d9ca] animate-pulse-slow animate-glitch-text">
            INSCRITO
          </div>
        </div>
      </div>
    ...
    <div class="absolute -bottom-12 -right-12 w-24 h-24 bg-gradient-to-br from-[#3c3c36] to-[#1c1c1a] transform rotate-45 group-hover:from-[#72211d] group-hover:to-[#3c1210] transition-colors duration-700"></div>
    ...
    <div class="absolute inset-0 bg-gradient-to-t from-[#72211d]/0 to-transparent opacity-0 group-hover:opacity-30 transition-opacity duration-700 mix-blend-overlay"></div>
  </div>
</template>
...
@keyframes glitch-text {
  ...
  2% {
    text-shadow: -3px 0 2px rgba(226,217,202,0.7), 3px 0 2px rgba(114,33,29,0.7);
