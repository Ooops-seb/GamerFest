    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        <SettingsLayout>
            <div class="flex flex-col space-y-6">
                <HeadingSmall title="Información de perfil" description="Actualiza la información de tu cuenta" />
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div v-if="mustVerifyEmail && !user.email_verified_at">
                        <p class="-mt-4 text-sm text-muted-foreground">
                            Tu cuenta no está verificada. Antes de continuar, verifica tu correo electrónico haciendo clic en el enlace que te
                            enviamos por correo electrónico. Si no recibiste el correo electrónico, puedes solicitar otro haciendo clic en el
                            siguiente botón:
                            <Link
